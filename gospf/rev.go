...
const header = `~
~ hubply! http://hubply.github.io
~
`

const usageTemplate = `usage: gospf command [arguments]

The commands are:
{{range .}}
    {{.Name | printf "%-11s"}} {{.Short}}{{end}}

Use "gospf help [command]" for more information.
`

var helpTemplate = `usage: gospf {{.UsageLine}}
{{.Long}}
`
